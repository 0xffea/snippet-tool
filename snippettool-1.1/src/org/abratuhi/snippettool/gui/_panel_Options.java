...
public class _panel_Options extends JPanel implements ActionListener,
	...
	public _panel_Options(_frame_SnippetTool r, SnippetTool snippettool) {
		...
		cc_rubb = new HiWi_GUI_colourchooser(PrefUtil.String2Color(preferences
				.getProperty("local.color.rubbing")), Float
				.parseFloat(preferences.getProperty("local.alpha.rubbing")),
				this, this);
		cc_text = new HiWi_GUI_colourchooser(PrefUtil.String2Color(preferences
				.getProperty("local.color.text")), Float.parseFloat(preferences
				.getProperty("local.alpha.text")), this, this);
		cc_back = new HiWi_GUI_colourchooser(PrefUtil.String2Color(preferences
				.getProperty("local.color.marking.p")), Float
				.parseFloat(preferences.getProperty("local.alpha.marking.p")),
				this, this);
		cc_fore = new HiWi_GUI_colourchooser(PrefUtil.String2Color(preferences
				.getProperty("local.color.marking.a")), Float
				.parseFloat(preferences.getProperty("local.alpha.marking.a")),
				this, this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		preferences.setProperty("local.color.rubbing", PrefUtil
				.Color2String(cc_rubb.cc.getColor()));
		preferences.setProperty("local.color.text", PrefUtil
				.Color2String(cc_text.cc.getColor()));
		preferences.setProperty("local.color.marking.p", PrefUtil
				.Color2String(cc_back.cc.getColor()));
		preferences.setProperty("local.color.marking.a", PrefUtil
	...
	public void stateChanged(ChangeEvent e) {
		...
		if (e.getSource().equals(cc_rubb.as)) {
			...
			preferences.setProperty("local.alpha.rubbing", String
					.valueOf(value));
