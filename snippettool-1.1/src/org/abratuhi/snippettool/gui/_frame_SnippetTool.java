...
public class _frame_SnippetTool extends JFrame implements WindowListener{
	...
	/**
	 * Load Layout of application window. Size of each JPanel part of GUI is restores from previous session
	 */
	...
	public static void main(String[] args){
		SwingUtilities.invokeLater(new Runnable(){
			@Override
			public void run(){
				new _frame_SnippetTool().createAndShowGUI();
			}
		});
	}
