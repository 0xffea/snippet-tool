...
public class ImageCutter {
	...
	public String getUsage(){
		return new String("usage: java -jar imagecutter.jar -inscript [inscript_uri] -rubbing [rubbing_uri] -savemode [remote/local] -basename [snippet_basename]");
	}
	...
	public static void main(String[] args){
		...
		if(inscript_uri != null && rubbing_uri != null && mode != null && basename != null){
			imagecutter.snippettool.setInscriptText("remote",
					inscript_uri.substring(0, inscript_uri.lastIndexOf("/")), 
					inscript_uri.substring(inscript_uri.lastIndexOf("/")+1));
			imagecutter.snippettool.setInscriptImage("remote",
					rubbing_uri.substring(0, rubbing_uri.lastIndexOf("/")),
					rubbing_uri.substring(rubbing_uri.lastIndexOf("/")+1));
